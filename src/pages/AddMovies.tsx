  ...
  return (
    <div className='flex flex-col px-4 sm:px-6'>
      ...
      <div className="flex justify-center items-center flex-col mt-20 sm:mt-32 lg:mt-40">
        ...
        <p className="flex justify-center items-center gap-2 text-sm text-gray-600 font-medium border border-neutral-200 px-3 py-1 rounded-3xl text-center">
          <span className='bg-amber-500 rounded-full h-2.5 w-2.5 inline-block'></span>
        ...
        <p className="text-gray-600 text-center w-full sm:w-[420px] md:w-[560px] text-sm sm:text-base">
      ...
      <div className='w-full flex justify-center items-center flex-col mt-10'>
        ...
        <div className='flex flex-col sm:flex-row justify-center items-center gap-5 w-full'>
          <div className='flex flex-col justify-start items-start w-full sm:w-auto'>
            ...
            <input
              ...
              type="text"
              className='h-11 mt-1 w-full sm:w-100 border px-4 border-neutral-200 rounded-sm'
            />
          </div>
        ...
        {/* description */}
        <div className='flex flex-col items-start justify-start mt-4 w-full sm:w-205'>
          <p className='text-gray-800 font-medium text-sm'>Description</p>
          <textarea
            value={description}
            onChange={(e) => setdescription(e.target.value)}
            className='w-full h-40 border px-4 py-2 border-neutral-200 rounded-sm mt-1'
          />
        </div>

        {/* price + genre */}
        <div className='flex flex-col sm:flex-row justify-center items-center gap-5 mt-5 w-full'>
          <div className='flex flex-col justify-start items-start w-full sm:w-auto'>
          ...
          <div className='flex flex-col justify-start items-start w-full sm:w-auto'>
            ...
            <select
              ...
              value={selectedGenre}
              className='w-full sm:w-100 h-11 mt-1 border border-neutral-200 rounded-sm px-4'
            >
        ...
        {/* movie banner */}
        <div className='flex flex-col justify-start items-start mt-5 w-full sm:w-205'>
          ...
          <div className='flex flex-col sm:flex-row gap-5 w-full'>
            <input
              ...
              type="file"
              className='mt-2 cursor-pointer w-full sm:w-100'
            />

            <img
              src={imagePriview}
              alt="preview image"
              className='p-5 border border-neutral-200 rounded-sm w-full sm:w-100'
            />
          </div>
        </div>

        {/* publish */}
        <div className='flex justify-end items-end w-full sm:w-205 my-5'>
          <button
            onClick={saveMovie}
            className='cursor-pointer bg-amber-500 py-2 px-4 rounded-sm font-medium hover:opacity-80'
          >
            Published Movie
          </button>
        </div>
